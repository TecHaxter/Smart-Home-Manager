...
class TempDial extends StatefulWidget {
  const TempDial({Key? key}) : super(key: key);

  @override
  State<TempDial> createState() => _TempDialState();
}

class _TempDialState extends State<TempDial> {
  double _angle = 0.0;
                                ...
                                onPanUpdate: (details) {
                                  ...
                                  setState(
                                    () {
                                      ...
                                      double curr = leftLimit - _angle;
                                      temperature =
                                          ((curr.abs() / 0.22) + 14).round();
                                    },
                                  );
                                },
                                child: Wrap(
